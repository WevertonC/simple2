...
/**
 * Classe responsavel por executar as operacoes do filtro prewitt.
 ...
 */
public class FiltroPrewitt extends FiltroAbstrato {
	
	/**
	 * Construtor de um filtro prewitt
	 * @param filterOperation operacao a ser realizada
	 * @param image imagem a ser realizada a operacao
	 */
	public FiltroPrewitt(ImagemFiltroOperacao filterOperation,
			BufferedImage image) {
		super(filterOperation, image);
	}
	
	/**
	 * Metodo que cria a mascara para o filtro prewitt
