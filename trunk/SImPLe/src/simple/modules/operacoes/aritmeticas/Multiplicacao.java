 ...
 */
//TODO - M�todo muito grande, pode ser modularizado em pequenos mtodos privados.
//todas as variaveis declaradas dentro do m�todo.
//n�o existem coment�rios que expliquem o passo a passo do algoritmo
public class Multiplicacao {
	...
	/**
	 * Metodo multiplica que multiplica varias imagens gerando uma outra com a multiplicacao
	 ...
	 */
	public static Image multiplica(List<ImageIcon> imagensIcon) throws OperacaoAritmeticaException{
		imageResultHeight = 0;
		imageResultWidth = 0;
		int altura, largura;
		...
		while (k < imagensIcon.size()) {
			...
			for (int i = 0; i < altura; i++) 
				for (int j = 0; j < largura; j++) 
					resultImage[PixelUtils.getIndex(i, j, imageResultWidth)] =  PixelUtils.multiplyPixels(
							resultImage[PixelUtils.getIndex(i, j, imageResultWidth)],PixelUtils.getPixel(pixels, i, j, largura));
			k++;
		}
