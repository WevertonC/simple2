...
/**
 * Classe de Excecao que deve ser lançada pelas classes do pacote fePDI.operacoesAritmeticas, 
 * caso as classe Adicao, Divisao, Multiplicacao e Subtracao caso essas não consigam capturar
 * os pixels da imagem.
 * 
...
public class OperacaoAritmeticaException extends Exception {
	...
	/**
	 * Cria uma exceção que deve ser lançada pelas classes do pacote fePDI.operacoesAritmeticas, 
	 * caso as classe Adicao, Divisao, Multiplicacao e Subtracao caso essas não consigam capturar
	 * os pixels da imagem.
	 ...
	 * Cria uma exceção que deve ser lançada pelas classes do pacote fePDI.operacoesAritmeticas, 
     * caso as classe Adicao, Divisao, Multiplicacao e Subtracao caso essas não consigam capturar
     * os pixels da imagem. A mensagem resultando do erro é default.
	 */
