...
/**
 * Classe de Excecao que deve ser lançada pelas classes do pacote fePDI.operacoesLogicas, 
 * caso as classe And, NAnd, NOr, Or, XOr, Not caso essas não consigam capturar
 * os pixels da imagem.
 * 
...
public class OperacaoLogicaException extends Exception {
	...
	/**
	 * Cria uma exceção que deve ser lançada pelas classes do pacote fePDI.operacoesLogicas, 
	 * caso as classe And, NAnd, NOr, Or, XOr, Not caso essas não consigam capturar
	 * os pixels da imagem.
